...
function Feed() {
  ...
  },
  {
    ...
    date: 'Apr 05, 2022',
    author: 'Liberland',
    text: 'Liberland Merit (LLM) is the official politics and citizenship token of the Liberland blockchain. It represents political power in Liberland, and can be used to gain citizenship, interact with government services or delegated (PolitiPooled) to representatives, who then use it to vote on Law proposals. Maximum possible supply of LLM is 70 million. It is expected to close in on that cap by 2070. ',
    hashtags: ['#LLM', '#Theory'],
    type: 'president',
  },
  {
    ...
    date: 'Apr 01, 2022',
    author: 'Liberland',
    text: 'You can use your hard earned LLD to interact and trade with other people using the wallet functionality. The minimum unit of LLM, a grain, is 10^-12 LLM - so make sure to select the proper unit. ',
  ...
  },
  {
    ...
    date: 'March 27, 2022',
    author: 'Liberland',
    text: 'In order to interact with the Liberland blockchain, you will need to setup a wallet. Keep your wallet info secured, as it represents you on the blockchain. We recommend using a polkadotJs browser extension. Learn more at https://liberland-1.gitbook.io/wiki/v/public-documents/blockchain/how-to-create-wallet ',
