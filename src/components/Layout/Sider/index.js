/* eslint-disable max-len, react/jsx-indent, react/function-component-definition */
    ...
    items: [
      ...
      },
      {
        ...
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M16 12.5h2.5" />
          <path d="M2.5 9.5h13a2 2 0 0 1 2 2" />
              </svg>,
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M4.8 16.2c.5-1.7 1.8-2.6 3.2-2.6s2.7.9 3.2 2.6" />
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Legislation',
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          <path d="M5 4.5h11a2 2 0 0 1 2 2V21l-3-2-3 2-3-2-3 2V6.5a2 2 0 0 1 2-2Z" />
          <path d="M8.5 9h6M8.5 12.5h6M8.5 16h3" />
              </svg>,
      },
      {
  ...
  return (
    <aside className={styles.sider}>
      ...
      <div className={styles.footer}>
        <span className={`${styles.networkDot} ${getSelectedNetwork() === 'testnet' ? styles.networkDotTestnet : ''}`} aria-hidden="true" />
        <span className={styles.networkLabel}>
          {NETWORKS[getSelectedNetwork()].label}
          {' '}
          synced
        </span>
        {blockNumber != null && (
